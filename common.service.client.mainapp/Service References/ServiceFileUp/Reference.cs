...
namespace common.service.client.mainapp.ServiceFileUp {
    ...
    public interface IStreamed {
        ...
        common.service.client.mainapp.ServiceFileUp.DownloadResult DownloadFile(common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStreamed/DownloadFile", ReplyAction="http://tempuri.org/IStreamed/DownloadFileResponse")]
        System.Threading.Tasks.Task<common.service.client.mainapp.ServiceFileUp.DownloadResult> DownloadFileAsync(common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper request);
    }
    ...
    public partial class StreamedClient : System.ServiceModel.ClientBase<common.service.client.mainapp.ServiceFileUp.IStreamed>, common.service.client.mainapp.ServiceFileUp.IStreamed {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        common.service.client.mainapp.ServiceFileUp.DownloadResult common.service.client.mainapp.ServiceFileUp.IStreamed.DownloadFile(common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper request) {
            return base.Channel.DownloadFile(request);
        }
        
        public long DownloadFile(ref string FilePath, out bool ReturnResult, out System.IO.Stream FileData) {
            common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper inValue = new common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper();
            inValue.FilePath = FilePath;
            common.service.client.mainapp.ServiceFileUp.DownloadResult retVal = ((common.service.client.mainapp.ServiceFileUp.IStreamed)(this)).DownloadFile(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<common.service.client.mainapp.ServiceFileUp.DownloadResult> common.service.client.mainapp.ServiceFileUp.IStreamed.DownloadFileAsync(common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper request) {
            return base.Channel.DownloadFileAsync(request);
        }
        
        public System.Threading.Tasks.Task<common.service.client.mainapp.ServiceFileUp.DownloadResult> DownloadFileAsync(string FilePath) {
            common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper inValue = new common.service.client.mainapp.ServiceFileUp.DownloadFileWrapper();
            inValue.FilePath = FilePath;
            return ((common.service.client.mainapp.ServiceFileUp.IStreamed)(this)).DownloadFileAsync(inValue);
        }
    }
}
